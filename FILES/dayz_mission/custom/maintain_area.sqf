...
_requirements = [];
switch true do {
	case (_count <= 10):  {_requirements = [["ItemGoldBar",4]]};
	case (_count <= 20):  {_requirements = [["ItemGoldBar",8]]};
	case (_count <= 35):  {_requirements = [["ItemGoldBar10oz",3]]};
	case (_count <= 50):  {_requirements = [["ItemGoldBar10oz",6]]};
	case (_count <= 75):  {_requirements = [["ItemGoldBar10oz",8]]};
	case (_count <= 100): {_requirements = [["ItemBriefcase100oz",1]]};
	case (_count <= 175): {_requirements = [["ItemBriefcase100oz",3]]};
	case (_count <= 250): {_requirements = [["ItemBriefcase100oz",5]]};
	case (_count <= 325): {_requirements = [["ItemBriefcase100oz",8]]};
	case (_count <= 400): {_requirements = [["ItemBriefcase100oz",11]]};
	case (_count <= 475): {_requirements = [["ItemBriefcase100oz",12]]};
	case (_count <= 550): {_requirements = [["ItemBriefcase100oz",13]]};
	case (_count <= 625): {_requirements = [["ItemBriefcase100oz",14]]};
	case (_count > 625):  {_requirements = [["ItemBriefcase100oz",20]]};
};
