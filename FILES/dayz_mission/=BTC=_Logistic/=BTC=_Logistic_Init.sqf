...
BTC_lift_max_h   = 40;
BTC_lift_radius  = 5;
BTC_Liftable     = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","StaticWeapon","Air","Tank","Plane"];
BTC_Hud_Cond     = false;
...
BTC_get_liftable_array =
{
	...
	switch (typeOf _chopper) do
	{
		...
		case "UH1Y"        : {_array = ["Motorcycle","Car","Wheeled_APC"];};
		case "UH60M_EP1_DZE"   : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
		case "UH60M_EP1_DZ"   : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
		case "UH60M_EP1"   : {_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "BAF_Merlin_HC3_D": {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
		case "MH60S"           : {_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "CH_47F_EP1_DZ"  :  {_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Tank","StaticWeapon","Air","Helicopter","Plane"];};
		case "CH_47F_EP1_DZE"  : {_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Tank","StaticWeapon","Air","Helicopter","Plane"];};
		case "CH_47F_BAF"  : {_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Tank","StaticWeapon","Air","Helicopter","Plane"];};
		case "Mi17_Civilian_DZ": {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
		case "Mi17_DZ"         : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
		case "Mi171Sh_rockets_CZ_EP1"         : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
		case "Mi17_DZE"        : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
		case "CH53_DZE"        : {_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC","Tank","StaticWeapon","Air","Helicopter","Plane"];};
		case "pook_H13_civ_ru_black" : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
	};
	_array
};
