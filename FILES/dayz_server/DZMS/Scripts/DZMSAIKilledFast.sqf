...
if (DZMSUseRPG AND ("RPG7V" in (weapons _unit))) then {
	...
	_unit removeMagazines "PG7VL";
};
if (("Stinger" in (weapons _unit))) then {
	_unit removeWeapon "Stinger";
	_unit removeMagazines "Stinger";
};
if (("RPG18" in (weapons _unit))) then {
	_unit removeWeapon "RPG18";
	_unit removeMagazines "RPG18";
};
