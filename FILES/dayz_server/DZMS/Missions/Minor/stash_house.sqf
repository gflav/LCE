...
_hint = parseText format["<t align='center' color='#31cefb' shadow='2' size='1.55'>Bandit Stashhouse</t><br/><t align='center' color='#ffffff'>Bandits have set up a Weapon Stash House! Go Empty it Out!</t>"];
...
[[(_coords select 0) - 4.0796, (_coords select 1) - 11.709,0],2,3,"DZMSUnitsMinor"] call DZMSAISpawn;
sleep 3;
[[(_coords select 0) + 2.8872, (_coords select 1) + 18.964,0],1,3,"DZMSUnitsMinor"] call DZMSAISpawn;
sleep 3;
...
// Send message to users
_hint = parseText format["<t align='center' color='#00ff00' shadow='2' size='1.55'>Bandit Stashhouse</t><br/><t align='center' color='#ffffff'>The Stash House is under Survivor Control!</t>"];
customRemoteMessage = ['hint', _hint];
publicVariable "customRemoteMessage";
