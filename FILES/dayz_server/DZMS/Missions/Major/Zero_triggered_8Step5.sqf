...
private ["_missName","_coords","_crate","_building","_building1","_building2","_building3","_building4","_building5","_building6","_building7","_chopper"];

//Name of the Mission
_missName = "Zero 8 outpost 5";
//DZMSFindPos loops BIS_fnc_findSafePos until it gets a valid result
_coords = call DZMSFindPos;

diag_log text format["[DZMS]: Zero 8 Outpost 3 triggered."];

//DZMSAddMajMarker is a simple script that adds a marker to the location
[_coords,_missname] ExecVM DZMSAddZero8Marker;

[nil,nil,rTitleText,"The last outpost is marked on the map! If captured, the Zero 8 crate will spawn!", "PLAIN",10] call RE;



//We create the vehicles like normal
_ranChopper = ["heli"] call DZMSGetVeh;
_chopper = createVehicle [_ranChopper,[(_coords select 0)+11.5,(_coords select 1)+14.5,0],[], 0, "NONE"];
...
[[(_coords select 0)-2.5,(_coords select 1)+5.5,0],4,3,"DZMSUnitsZeroOutpost"] call DZMSAISpawnZeroOutpost;
sleep 1;
[[(_coords select 0)-7.5,(_coords select 1)-3.5,0],4,3,"DZMSUnitsZeroOutpost"] call DZMSAISpawnZeroOutpost;
sleep 1;
[[(_coords select 0)-10.5,(_coords select 1)-7.5,0],4,3,"DZMSUnitsZeroOutpost"] call DZMSAISpawnZeroOutpost;
sleep 1;
...
_crate = createVehicle ["LocalBasicAmmunitionBox",[(_coords select 0)+2.7876, (_coords select 1)+2.2220,0],[], 0, "CAN_COLLIDE"];
...
[nil,nil,rTitleText,"The last Zero 8 Outpost has been captured.", "PLAIN",10] call RE;
