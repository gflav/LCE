...
[nil,nil,rTitleText,"A Zero 8 Outpost is marked on the map!", "PLAIN",10] call RE;

//DZMSAISpawn spawns AI to the mission.
//Usage: [_coords, count, skillLevel, unitArray] [160.168,[8119.05,13504.2,0.00164795]]
[[(_coords select 0)-9.5,(_coords select 1)+6.5,0],3,3,"DZMSUnitsZeroOutpost"] call DZMSAISpawnZeroOutpost;
sleep 1;
[[(_coords select 0)+3.5,(_coords select 1)+3.5,0],3,3,"DZMSUnitsZeroOutpost"] call DZMSAISpawnZeroOutpost;
sleep 1;
[[(_coords select 0)-15.5,(_coords select 1)-16.5,0],3,3,"DZMSUnitsZeroOutpost"] call DZMSAISpawnZeroOutpost;
sleep 1;
...
[nil,nil,rTitleText,"The second Zero 8 Outpost has been captured.", "PLAIN",10] call RE;

diag_log text format["[DZMS]: Zero 8 Step 2 Bandits have been wiped out."];
