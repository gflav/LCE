...
_hint = parseText format["<t align='center' color='#ff0000' shadow='2' size='1.55'>Plane Crash</t><br/><t align='center' color='#ffffff'>A C130 Carrying Supplies has Crashed! Bandits are Securing the Cargo!</t>"];
...
[[(_coords select 0) - 10.5005,(_coords select 1) - 2.6465,0],2,3,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) + 4.7027,(_coords select 1) + 12.2138,0],2,3,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) + 2.918,(_coords select 1) - 9.0342,0],2,3,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 5;
[[(_coords select 0) - 1.918,(_coords select 1) - 3.0342,0],2,3,"DZMSUnitsMajor"] call DZMSAISpawn;
...
// Send message to users
_hint = parseText format["<t align='center' color='#00ff00' shadow='2' size='1.55'>Plane Crash</t><br/><t align='center' color='#ffffff'>The Crash Site has been Secured by Survivors!</t>"];
customRemoteMessage = ['hint', _hint];
publicVariable "customRemoteMessage";
