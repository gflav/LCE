...
DZAI_unitBloodLevel = [10000,18000];
...
DZAI_respawnTMinA = 7000;
DZAI_respawnTMaxA = 9000;
...
DZAI_waypointBlacklist = ["staryblacklist"];
...
DZAI_gradeChances3 = [0.00,0.50,0.35,0.95];	
...
DZAI_Rifles3 = ["FN_FAL","Mk_48_DZ","M249_DZ","BAF_L85A2_RIS_Holo","AK_47_M","AKS_74_U","M14_EP1","DMR_DZ","RPK_74","M4A1_AIM_SD_camo"]; //Weapongrade 3 rifles
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_MiscItemS = ["ItemSodaCoke", "ItemSodaPepsi", "ItemWaterbottle", "FoodCanSardines", "FoodCanBakedBeans", "FoodCanFrankBeans", "FoodCanPasta", "ItemWaterbottleUnfilled","ItemWaterbottleBoiled","FoodmuttonCooked","FoodchickenCooked","FoodBaconCooked","FoodRabbitCooked","FoodbaconRaw","FoodchickenRaw","FoodmuttonRaw","foodrabbitRaw","FoodCanUnlabeled","FoodPistachio","FoodNutmix","FoodMRE",'ItemTopaz','ItemObsidian','ItemSapphire','ItemAmethyst','ItemEmerald','ItemCitrine'];
DZAI_MiscItemL = ['NLAW','PG7VL','30m_plot_kit','Dragon_EP1','FoodrabbitRaw','MAAWS_HEAT',"Stinger","Javelin",'PG7VR','Skin_Soldier_Sniper_PMC_DZ','2000Rnd_762x51_M134',"ItemBriefcase100oz",'PMC_ied_v4','PMC_ied_v2','RPG18','ItemGoldBar10oz'];
