/*
	...
	----------------------------------------
	Created by Hertizch for Sliced N' Diced.
	----------------------------------------
...
if (true) then
{
  _this = createVehicle ["Land_Mil_Barracks_i", [8570.9658, 8101.7725, 0.12629919], [], 0, "CAN_COLLIDE"];
  _vehicle_141 = _this;
...
if (true) then
{
  _this = createVehicle ["Land_Mil_Barracks_i", [8516.3945, 8091.0186, 0.25813976], [], 0, "CAN_COLLIDE"];
  _vehicle_165 = _this;
  _this setDir 333.90945;
